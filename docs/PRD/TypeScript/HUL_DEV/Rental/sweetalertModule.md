...
script:
  type: TBD
  file: TypeScript/HUL_DEV/Rental/sweetalertModule.ts
  script_id: TBD
  deployment_id: TBD
...
## 3. User Story
As a developer, when I need common warnings, I want shared SweetAlert2 helper functions, so that messaging is consistent.
