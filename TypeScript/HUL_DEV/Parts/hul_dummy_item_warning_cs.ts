...
* @since 2015.2
*/
function pageInit(ctx: EntryPoints.Client.pageInitContext): void {
    sweetAlert.preload();
}
...
* @since 2015.2
*/
function fieldChanged(ctx: EntryPoints.Client.fieldChangedContext): void {
}
...
* @since 2015.2
*/
function sublistChanged(ctx: EntryPoints.Client.sublistChangedContext): void {
}
...
* @since 2015.2
*/
function postSourcing(ctx: EntryPoints.Client.postSourcingContext): void {
}
...
* @since 2015.2
*/
function lineInit(ctx: EntryPoints.Client.lineInitContext): void {
}
...
* @since 2015.2
*/
function validateLine(ctx: EntryPoints.Client.validateLineContext): boolean {
    return true;
}
...
* @since 2015.2
*/
function validateField(ctx: EntryPoints.Client.validateFieldContext): boolean {
    return true;
}
...
* @since 2015.2
*/
function validateDelete(ctx: EntryPoints.Client.validateDeleteContext): boolean {
    return true;
}
...
* @since 2015.2
*/
function validateInsert(ctx: EntryPoints.Client.validateInsertContext): boolean {
    return true;
}
...
* @since 2015.2
*/
function saveRecord(ctx: EntryPoints.Client.saveRecordContext): boolean {
    try {
        const currentRecord = ctx.currentRecord;
        const targetItemIDs: string[] = ['88727','86344','94479'];
        const foundLine = findItemInSublist(currentRecord, targetItemIDs);
...
const findItemInSublist = (currentRecord: any, targetItemIDs: string[]): number | null => {
    try {
        const lineCount = currentRecord.getLineCount({ sublistId: 'item' });
        for (let i = 0; i < lineCount; i++) {
            const itemID = String(currentRecord.getSublistValue({
                sublistId: 'item',
                fieldId: 'item',
                line: i
            }));
            ...
            if (targetItemIDs.indexOf(itemID) !== -1) {
                console.log('Item Found', `Item ID ${itemID} found in sublist at line ${i}.`);
                return i;
            }
        }
        return null;
