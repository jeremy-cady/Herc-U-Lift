...
* =======================================================================================================
* 2023/01/26						            mdesilva      	Initial version
*
*/
...
define(['N/file', 'N/format', 'N/record', 'N/runtime', 'N/search', 'N/ui/serverWidget', 'N/url', 'N/render'],
    ...
    (file, format, record, runtime, search, serverWidget, url, render) => {
        ...
        function createReport(runtime, objRecord, objPrintData, stTranName) {
            ...
            var stEstimatePDFTemplate = runtime.getCurrentScript().getParameter('custscript_param_quotetaskpdftemplate');
            // template id = 2093 - sna_hu_quote_per_task_template_xml.xml
			log.debug('stEstimatePDFTemplate', 'stEstimatePDFTemplate = ' + stEstimatePDFTemplate);
            var stRightLogoURL = runtime.getCurrentScript().getParameter('custscript_param_qt_rightlogourl');
            var objFile = null;
            try
            {
