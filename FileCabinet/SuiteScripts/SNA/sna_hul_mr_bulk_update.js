 ...
 * Map/reduce script to trigger the UE scripts
 * Revision History:
 *
 * Date              Issue/Case          Author          Issue Fix Summary
 * =============================================================================================
 * 2024/04/11                            rdelacruz        Initial version
 *
 */
/**
 * @NApiVersion 2.1
...
define(['N/record', 'N/search', 'N/runtime'],
    ...
    (record, search, runtime) => {
        ...
        const SCRIPT_PARAMS = {
            _search : "custscript_sna_bulk_srch_upd",
        }
        ...
        const getInputData = (inputContext) => {
            ...
            let objSearch = search.load(objScript.getParameter(SCRIPT_PARAMS._search));
        ...
        const map = (mapContext) => {
            let objData = JSON.parse(mapContext.value);
        ...
        const summarize = (summaryContext) => {
            ...
            summaryContext.mapSummary.errors.iterator().each(function (key, error, executionNo) {
                log.error({
                    title: 'Key error for key: ' + key + ', execution no.  ' + executionNo,
                    details: error
                });
                return true;
            });
