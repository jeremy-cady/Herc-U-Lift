...
define(['N/file', 'N/format', 'N/record', 'N/runtime', 'N/search', 'N/ui/serverWidget', 'N/url', 'N/render'],
    ...
    (file, format, record, runtime, search, serverWidget, url, render) => {
        ...
        function createReport(runtime, objRecord, objPrintData, stTranName) {
            ...
            // file ID 2091 - sna_hul_quote_pdf_template.xml
            var stEstimatePDFTemplate = runtime.getCurrentScript().getParameter('custscript_param_quotepdftemplate');
            // internal ID 106 - Advanced PDF/HTML Template - SNA | Quote PDF/HTML Template
            var stQuoteAdvPDFTemplateId = runtime.getCurrentScript().getParameter('custscript_param_quote_advpdf_template');
            var stRightLogoURL = runtime.getCurrentScript().getParameter('custscript_param_quote_rightlogourl');
            var objFile = null;
            log.debug('stEstimatePDFTemplate', stEstimatePDFTemplate);
            log.debug('stQuoteAdvPDFTemplateId', stQuoteAdvPDFTemplateId);
            try
            {
                ...
                objPDFRenderer.setTemplateById(stQuoteAdvPDFTemplateId);
