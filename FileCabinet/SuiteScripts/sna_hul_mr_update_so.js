 ...
 * Trigger User Event Script "SNA HUL | UE | SO/Quote Lines Update"
 *
 * Revision History:
 *
 * Date			            Issue/Case		    Author			    Issue Fix Summary
 * =======================================================================================================
 * 2023/05/05						            caranda           	Initial version
/**
 * @NApiVersion 2.1
 ...
 */
    (record, search, runtime) => {
        ...
        const getInputData = () => {
            ...
            var searchId = scriptObj.getParameter({name: 'custscript_sna_update_so_srch'});
        ...
        const reduce = (reduceContext) => {
            ...
            log.debug(stLoggerTitle, '*** START *** | SO ID =' + reduceContext.key);
            ...
            try{
                ...
                log.debug(stLoggerTitle, '*** END *** | SO ID =' + soRecId);
            }catch (e) {
