...
define(['N/format', 'N/search', 'N/ui/dialog', 'N/url', 'N/https'],
    function(format, search, dialog, url, https) {
        ...
        /**
         * Export to PDF - Triggered by Export button
         */
        function exportToPDF() {
            try {
                // Use form submission to preserve script/deploy parameters
                ...
                // Create or update hidden field for export parameter
                var exportField = document.getElementById('custpage_export_pdf_flag');
                if (!exportField) {
                    exportField = document.createElement('input');
                    exportField.type = 'hidden';
                    exportField.id = 'custpage_export_pdf_flag';
                    exportField.name = 'export';
                    form.appendChild(exportField);
                }
                exportField.value = 'pdf';

                console.log('Submitting form for PDF export');

                // Submit the form (this preserves script and deploy parameters)
                form.submit();
