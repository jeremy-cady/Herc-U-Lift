 ...
 */
define(["require", "exports", "N/ui/serverWidget", "N/url", "N/log"], function (require, exports, serverWidget, url, log) {
    "use strict";
    ...
    function getSuiteletUrl() {
        try {
            ...
            log.error({ title: 'resolveScript FAILED', details: String(e?.message || e) });
            return '';
        }
    }
    function addInlineClientBootstrap(form) {
        const js = [
            '(function(){',
    ...
    function beforeLoad(ctx) {
        try {
            ...
            if (!isCreate && !isEdit) {
                log.debug({ title: 'UE EXIT', details: 'Not CREATE/EDIT' });
                return;
            }
            const form = ctx.form;
            ...
            log.error({ title: 'UE beforeLoad FATAL', details: String(e?.message || e) });
        }
    }
    exports.beforeLoad = beforeLoad;
    function beforeSubmit(_ctx) { }
    exports.beforeSubmit = beforeSubmit;
    function afterSubmit(_ctx) { }
