 ...
 */
define(["require", "exports", "N/query", "N/record", "N/log", "N/email", "N/runtime"], function (require, exports, query, record, log, email, runtime) {
    "use strict";
    const FIELD_DO_NOT_SYNC = 'custbody_versapay_do_not_sync';
    // External revenue stream values → uncheck when matched
    const revStreamExternalValues = [
    ...
    const revStreamExternalSet = new Set(revStreamExternalValues);
...
`;
    ...
    function buildEmailBody(changed, skipped, noRevStream, errors) {
        return [
